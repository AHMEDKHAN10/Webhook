...
int analogvalue = 0;// Here we are declaring the integer variable analogvalue, which we will use later to store the value of the photoresistor or phototransistor.
//char light[30];
...
//	Particle.variable("analogvalue", &analogvalue);
 ...
 //   Particle.variable("light_sensor", light);
